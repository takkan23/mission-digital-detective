...
console.log(
  "### TEACHER EVOLVE V6 RUBRIC LOADED ###"
);
...
document.addEventListener(
  ...
  async function () {
    ...
    const evolveRubricCriteria = {
      ...
      evolveScore3: {
        title: "3. รู้สิทธิ : เคารพสิทธิและอ้างอิงแหล่งที่มา",
        levels: {
          4: "ระบุแหล่งข้อมูลครบถ้วน และหากใช้ภาพ/สื่อจากผู้อื่น ระบุที่มาครบถ้วนและใช้อย่างเหมาะสม",
          3: "ระบุแหล่งข้อมูลส่วนใหญ่ครบถ้วน และหากใช้ภาพ/สื่อจากผู้อื่น ระบุที่มาบางส่วน",
          2: "ระบุแหล่งที่มาเพียงบางส่วนหรือไม่ครบถ้วน แต่ยังใช้ข้อมูล/สื่ออย่างเหมาะสม",
          1: "ไม่ระบุแหล่งที่มา หรือใช้ข้อมูล/สื่อไม่เหมาะสมหรือละเมิดสิทธิผู้อื่น"
        }
      },
      evolveScore4: {
        title: "4. รู้สื่อ : สื่อสารด้วยอินโฟกราฟิก",
        levels: {
          4: "เนื้อหาถูกต้อง ชัดเจน จัดลำดับดี และใช้ภาพ/ไอคอน/แผนภาพ/กราฟิกช่วยสื่อความหมายอย่างเหมาะสม",
          3: "เนื้อหาถูกต้อง เข้าใจง่าย และมีองค์ประกอบกราฟิกช่วยสื่อความหมาย",
          2: "เนื้อหาพอเข้าใจ แต่มีกราฟิกน้อยหรือกราฟิกไม่ช่วยสื่อความหมาย",
          1: "เนื้อหาไม่ชัดเจน หรือเป็นข้อความเป็นหลักโดยไม่มีองค์ประกอบกราฟิกที่เหมาะสม"
        }
      }
    };
